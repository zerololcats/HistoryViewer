    ...
    events: [
      {
        ...
        wikipediaUrl: "https://en.wikipedia.org/wiki/Renaissance", ...getImage("img-general-events-ge-3")
      },
      {
        ...
        wikipediaUrl: "https://en.wikipedia.org/wiki/Printing_press", ...getImage("img-general-events-ge-1")
      },
      {
        ...
        wikipediaUrl: "https://en.wikipedia.org/wiki/Fall_of_Constantinople", ...getImage("img-general-events-ge-2")
      },
      {
        ...
        wikipediaUrl: "https://en.wikipedia.org/wiki/Voyages_of_Christopher_Columbus", ...getImage("img-general-events-ge-4")
      },
      {
        ...
        wikipediaUrl: "https://en.wikipedia.org/wiki/Reformation", ...getImage("img-general-events-ge-5")
      },
      {
        ...
        wikipediaUrl: "https://en.wikipedia.org/wiki/French_Revolution", ...getImage("img-general-events-ge-6")
      },
      {
        ...
        wikipediaUrl: "https://en.wikipedia.org/wiki/Invention_of_the_telephone", ...getImage("img-general-events-ge-7")
      },
      {
        ...
        wikipediaUrl: "https://en.wikipedia.org/wiki/Wright_brothers", ...getImage("img-general-events-ge-8")
      },
      {
        ...
        wikipediaUrl: "https://en.wikipedia.org/wiki/History_of_penicillin", ...getImage("img-general-events-ge-9")
      },
      {
        ...
        wikipediaUrl: "https://en.wikipedia.org/wiki/World_Wide_Web", ...getImage("img-general-events-ge-10")
      }
    ...
    events: [
      {
        ...
        wikipediaUrl: "https://en.wikipedia.org/wiki/Sputnik_1", ...getImage("img-space-race-sr-1")
      },
      {
        id: "sr-2", title: "Explorer 1 Launch", date: "1958-01-31", 
        description: "The United States launches its first satellite, Explorer 1.",
        wikipediaUrl: "https://en.wikipedia.org/wiki/Explorer_1", ...getImage("img-space-race-sr-2")
      },
      {
        ...
        wikipediaUrl: "https://en.wikipedia.org/wiki/Yuri_Gagarin", ...getImage("img-space-race-sr-3")
      },
      {
        ...
        wikipediaUrl: "https://en.wikipedia.org/wiki/Alan_Shepard", ...getImage("img-space-race-sr-4")
      },
      {
        ...
        wikipediaUrl: "https://en.wikipedia.org/wiki/John_Glenn", ...getImage("img-space-race-sr-5")
      },
      {
        ...
        wikipediaUrl: "https://en.wikipedia.org/wiki/Valentina_Tereshkova", ...getImage("img-space-race-sr-6")
      },
      {
        ...
        wikipediaUrl: "https://en.wikipedia.org/wiki/Alexei_Leonov", ...getImage("img-space-race-sr-7")
      },
      {
        ...
        wikipediaUrl: "https://en.wikipedia.org/wiki/Apollo_8", ...getImage("img-space-race-sr-8")
      },
      {
        ...
        wikipediaUrl: "https://en.wikipedia.org/wiki/Apollo_11", ...getImage("img-space-race-sr-9")
      },
      {
        ...
        wikipediaUrl: "https://en.wikipedia.org/wiki/International_Space_Station", ...getImage("img-space-race-sr-10")
      }
    ].sort((a, b) => new Date(a.date).getTime() - new Date(b.date).getTime()),
  },
  {
    ...
    events: [
      {
        ...
        wikipediaUrl: "https://en.wikipedia.org/wiki/Invasion_of_Poland", ...getImage("img-world-war-2-ww2-1")
      },
      {
        ...
        wikipediaUrl: "https://en.wikipedia.org/wiki/Battle_of_Britain", ...getImage("img-world-war-2-ww2-2")
      },
      {
        ...
        wikipediaUrl: "https://en.wikipedia.org/wiki/Operation_Barbarossa", ...getImage("img-world-war-2-ww2-3")
      },
      {
        ...
        wikipediaUrl: "https://en.wikipedia.org/wiki/Attack_on_Pearl_Harbor", ...getImage("img-world-war-2-ww2-4")
      },
      {
        ...
        wikipediaUrl: "https://en.wikipedia.org/wiki/Battle_of_Stalingrad", ...getImage("img-world-war-2-ww2-5")
      },
      {
        ...
        wikipediaUrl: "https://en.wikipedia.org/wiki/D-Day", ...getImage("img-world-war-2-ww2-6")
      },
      {
        ...
        wikipediaUrl: "https://en.wikipedia.org/wiki/Battle_of_the_Bulge", ...getImage("img-world-war-2-ww2-7")
      },
      {
        ...
        wikipediaUrl: "https://en.wikipedia.org/wiki/Victory_in_Europe_Day", ...getImage("img-world-war-2-ww2-8")
      },
      {
        ...
        wikipediaUrl: "https://en.wikipedia.org/wiki/Atomic_bombings_of_Hiroshima_and_Nagasaki", ...getImage("img-world-war-2-ww2-9")
      },
      {
        id: "ww2-10", title: "Victory over Japan Day", date: "1945-09-02", 
        description: "Japan surrenders, officially ending World War II.",
        wikipediaUrl: "https://en.wikipedia.org/wiki/Victory_over_Japan_Day", ...getImage("img-world-war-2-ww2-10")
      }
    ].sort((a, b) => new Date(a.date).getTime() - new Date(b.date).getTime()),
  },
  {
    ...
    events: [
      {
        ...
        wikipediaUrl: "https://en.wikipedia.org/wiki/Assassination_of_Archduke_Franz_Ferdinand", ...getImage("img-world-war-1-ww1-1")
      },
      {
        ...
        wikipediaUrl: "https://en.wikipedia.org/wiki/Austro-Hungarian_declaration_of_war_on_Serbia", ...getImage("img-world-war-1-ww1-2")
      },
      {
        ...
        wikipediaUrl: "https://en.wikipedia.org/wiki/Declarations_of_war_during_World_War_I", ...getImage("img-world-war-1-ww1-16")
      },
      {
        ...
        wikipediaUrl: "https://en.wikipedia.org/wiki/German_invasion_of_Belgium", ...getImage("img-world-war-1-ww1-3")
      },
      {
        ...
        wikipediaUrl: "https://en.wikipedia.org/wiki/Battle_of_Tannenberg", ...getImage("img-world-war-1-ww1-4")
      },
      {
        ...
        wikipediaUrl: "https://en.wikipedia.org/wiki/First_Battle_of_the_Marne", ...getImage("img-world-war-1-ww1-5")
      },
      {
        ...
        wikipediaUrl: "https://en.wikipedia.org/wiki/Ottoman_entry_into_World_War_I", ...getImage("img-world-war-1-ww1-6")
      },
      {
        ...
        wikipediaUrl: "https://en.wikipedia.org/wiki/Gallipoli_campaign", ...getImage("img-world-war-1-ww1-17")
      },
      {
        ...
        wikipediaUrl: "https://en.wikipedia.org/wiki/Sinking_of_the_RMS_Lusitania", ...getImage("img-world-war-1-ww1-7")
      },
      {
        ...
        wikipediaUrl: "https://en.wikipedia.org/wiki/Italian_entry_into_World_War_I", ...getImage("img-world-war-1-ww1-18")
      },
      {
        ...
        wikipediaUrl: "https://en.wikipedia.org/wiki/Battle_of_Verdun", ...getImage("img-world-war-1-ww1-8")
      },
      {
        ...
        wikipediaUrl: "https://en.wikipedia.org/wiki/Battle_of_the_Somme", ...getImage("img-world-war-1-ww1-9")
      },
      {
        ...
        wikipediaUrl: "https://en.wikipedia.org/wiki/Zimmermann_Telegram", ...getImage("img-world-war-1-ww1-20")
      },
      {
        ...
        wikipediaUrl: "https://en.wikipedia.org/wiki/American_entry_into_World_War_I", ...getImage("img-world-war-1-ww1-10")
      },
      {
        ...
        wikipediaUrl: "https://en.wikipedia.org/wiki/October_Revolution", ...getImage("img-world-war-1-ww1-11")
      },
      {
        ...
        wikipediaUrl: "https://en.wikipedia.org/wiki/Fourteen_Points", ...getImage("img-world-war-1-ww1-12")
      },
      {
        ...
        wikipediaUrl: "https://en.wikipedia.org/wiki/Treaty_of_Brest-Litovsk", ...getImage("img-world-war-1-ww1-21")
      },
      {
        ...
        wikipediaUrl: "https://en.wikipedia.org/wiki/Second_Battle_of_the_Marne", ...getImage("img-world-war-1-ww1-22")
      },
      {
        ...
        wikipediaUrl: "https://en.wikipedia.org/wiki/Wilhelm_II,_German_Emperor#Abdication_and_flight", ...getImage("img-world-war-1-ww1-19")
      },
      {
        ...
        wikipediaUrl: "https://en.wikipedia.org/wiki/Armistice_of_11_November_1918", ...getImage("img-world-war-1-ww1-13")
      },
      {
        ...
        wikipediaUrl: "https://en.wikipedia.org/wiki/Paris_Peace_Conference,_1919", ...getImage("img-world-war-1-ww1-23")
      },
      {
        ...
        wikipediaUrl: "https://en.wikipedia.org/wiki/Treaty_of_Versailles", ...getImage("img-world-war-1-ww1-14")
      },
      {
        ...
        wikipediaUrl: "https://en.wikipedia.org/wiki/League_of_Nations", ...getImage("img-world-war-1-ww1-15")
      },
      {
        ...
        wikipediaUrl: "https://en.wikipedia.org/wiki/Treaty_of_Versailles#United_States", ...getImage("img-world-war-1-ww1-24")
      }
    ].sort((a, b) => new Date(a.date).getTime() - new Date(b.date).getTime()),
  }
];
